...
def writeFilterFromBowtie(outputDir, input1, input2, fileType, line, numProcessors, sf, delimiter):
    ...
    # create the output name
    thisAction = "_b" + config.BOWTIE_DB_ABBREV[pieces[1]]
    if not useMisses:
        thisAction += "Hits"
    ...
    bowtieLogFile = os.path.splitext(input1)[0] + thisAction + ".blatLog.txt"
    outputName2 = ""
    outputTempName2 = ""
    if input2:
...
def  writeFilterFromBlat(outputDir, inputFasta, line, numProcessors, sf, delimiter):
    ...
    # create the output name
    thisAction = "_l" + config.BLAT_DB_ABBREV[pieces[1]]
    if not useMisses:
        thisAction += "Hits"
...
def writeFilterFromBlast(outputDir, inputFasta, line, numProcessors, sf, delimiter):
    ...
    # create the output name
    thisAction = "_s" + config.BLAST_DB_ABBREV[pieces[1]]
    if not useMisses:
        thisAction += "Hits"
