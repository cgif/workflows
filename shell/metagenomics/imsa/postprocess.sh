...
cat $RESULTS_DIR/$RESULTS_FILE1_BASENAME.bln $RESULTS_DIR/$RESULTS_FILE2_BASENAME.bln > $TMPDIR/combined.bln

#create tax files
python $TMPDIR/$ANALYSIS/postprocess.py -b $TMPDIR/combined.bln
